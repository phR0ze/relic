...
//         info!("{}{}", "Removing components: ".yellow().bold(),
// Component::join(&component_vec).cyan());         for component in component_vec {
...
//             self.config_path = self.config_dir.mash(format!("{}.yaml", APP_NAME));
//             info!("{:>w$} {}", "defaulting config_dir:", self.config_dir.cyan()?, w =
// self.config_w);         }
